import 'package:chatapp/screens/authentication/forgetpassword.dart';
    ...
    return Scaffold(
      ...
      body:Center(child:SingleChildScrollView(
        ...
        child: SafeArea(
          child:Column(
            children: <Widget>[
            const CircleAvatar(backgroundImage: NetworkImage('https://news.artnet.com/app/news-upload/2023/01/automat.jpeg'),
              radius: 50.0,
            ),
